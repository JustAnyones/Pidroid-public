...
PIDROID_CANARY_ID = 762365831018577980
...
# Authorized users who can shut down the bot in case of emergency
# TODO: implement
CRITICAL_SHUTDOWN_USERS = [
    THEOTOWN_DEVELOPERS,
    329729373441884172 # Remains
]
...
FACTS = [
    'Javascript is isn\'t the greatest programming language in the world, but at least it counts its arrays from 0 unlike some other languages...',
    ...
    'The game is currently being developed by 2 people.',
    'The name Theo comes from a previous developer of the game called theotheoderich.',
